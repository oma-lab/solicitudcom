            ...
            <tbody>
             ...
             <tr>
               <td width="40%">
                ...
                <p style="text-align:justify;text-transform: lowercase;">{{limitar($reco->asunto())}}</p>
               </td>
               <td class="centrado">
                <a class="navbar-brand" href="{{url('storage/'.$reco->solicitud->solicitud_firmada)}}" target= "_blank">
