  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color: #ffffff;">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <a class="navbar-brand" href="{{ route('coordinador.dictamenes') }}" style="color: #000000;">
          <img src="{{ asset('imagenes/dictamen.png') }}" style="width:40px;"  ><b>Dictamenes</b>
        </a>
        <a class="navbar-brand" href="{{route('coordinador.calendario')}}">
          <img src="{{ asset('imagenes/calendario.png') }}" style="width:40px;"><b>Calendario</b>
        </a>
        <a class="navbar-brand" href="{{route('coordinador.editar')}}">
