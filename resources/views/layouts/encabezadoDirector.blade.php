  ...
  <body>
    <nav class="nav-menu">
      ...
      <ul class="menu">
        ...
        <li><a href="{{route('director.calendario')}}"><img src="{{ asset('imagenes/calendario.png') }}" style="width:40px;"><b>Agenda</b></a></li>
        <li><a href="{{route('director.editar')}}"><img src="{{ asset('imagenes/configuser.png') }}" style="width:40px;"><b>Usuario</b></a></li>
        <li>
