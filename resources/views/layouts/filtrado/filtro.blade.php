<nav class="navbar navbar-expand-lg navbar-light bg-light">
 ...
 <div class="collapse navbar-collapse" id="menu">
  @if(!usuario()->esAdmin())
  <select id="filtro" class="filtro form-control mr-sm-2" name="visto" style="width:200px">
    <option value="">NO VISTOS</option>
    <option value="true" {{request('visto') == 'true' ? 'selected' : ''}}>VISTOS</option>
  </select>
  @endif

  <ul class="navbar-nav mr-auto"></ul>
   @if(request('role_id') != 4)
    <select class="filtro form-control mr-sm-2" name="carrera_id" style="width:225px">
